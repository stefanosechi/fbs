    ...
    <>
      ...
      <AnimatePresence>
        {showScrollTop && (
          ...
          >
            ...
            <motion.div
              className="absolute -top-1 -right-1 w-3 h-3 border-t-2 border-r-2 border-black rounded-tr-lg"
              animate={{
                opacity: [0.3, 1, 0.3],
                scale: [0.8, 1.2, 0.8],
              }}
            ...
            />
            <motion.div
              className="absolute -bottom-1 -left-1 w-3 h-3 border-b-2 border-l-2 border-black rounded-bl-lg"
              animate={{
                opacity: [0.3, 1, 0.3],
                scale: [0.8, 1.2, 0.8],
              }}
      ...
      >
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute bottom-16 right-0 w-80 bg-white rounded-lg shadow-xl border border-gray-200 p-4 mb-2"
            >
              <div className="flex justify-between items-start mb-3">
                <div>
                  <h3 className="font-semibold text-gray-900">FBS Arredamenti</h3>
                  <p className="text-sm text-gray-500">Di solito risponde subito</p>
                </div>
        ...
        <motion.button
          ...
          className="w-14 h-14 bg-green-500 text-white rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 flex items-center justify-center relative overflow-hidden group"
        ...
        {/* Pulse animation per WhatsApp */}
        {!isOpen && (
          <motion.div
            className="absolute inset-0 w-14 h-14 bg-green-500 rounded-full opacity-20"
