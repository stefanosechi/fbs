...
const portfolioProjects = [
  {
    id: 1,
    title: "Villa Moderna - Alghero",
    category: "residenziale",
    year: "2024",
    location: "Alghero, SS",
    description: "Arredamento completo per villa di lusso con cucina, soggiorno e camere su misura",
  ...
  {
    id: 2,
    title: "Uffici Direzionali - Sassari",
    category: "commerciale",
    year: "2023",
    location: "Sassari, SS",
    description: "Progettazione e realizzazione uffici direzionali con sale riunioni e reception",
    image: "/placeholder.svg?height=600&width=800",
